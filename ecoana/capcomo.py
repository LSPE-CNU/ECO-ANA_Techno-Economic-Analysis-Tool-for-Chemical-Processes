...
def capcomo_Garrett(process, scale_tpy):
     if process ==None:
          ...
          Qmin=Param_Garrett.loc[process][0]
          Qmax=Param_Garrett.loc[process][1]
          a=Param_Garrett.loc[process][2]
          n=Param_Garrett.loc[process][3]
          Qunit=Param_Garrett.loc[process][4]
          Q=scale_tpy*Qunit
